...
func main() {
	...
	// Endpoint public.
	api.POST("/auth/login", middleware.LoginRateLimiter(redisClient, 5, 5*time.Minute), middleware.RegisterIdleSessionAfterLogin(redisClient, 30*time.Minute), authHandler.Login)
